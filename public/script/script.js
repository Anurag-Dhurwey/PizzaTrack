...
/* harmony import */ var notie__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! notie */ "./node_modules/notie/dist/notie.min.js");
/* harmony import */ var notie__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(notie__WEBPACK_IMPORTED_MODULE_0__);


var addToCart = document.querySelectorAll(".Add-to-cart");
var cart_counter = document.querySelector("#cart-counter");
var notifier = function notifier() {
  notie__WEBPACK_IMPORTED_MODULE_0___default().alert({
    type: 1,
...
var updateCart = function updateCart(itemIs) {
  axios__WEBPACK_IMPORTED_MODULE_1__["default"].post("/update-cart", itemIs).then(function (res) {
    notifier();
...
addToCart.forEach(function (btn) {
  btn.addEventListener("click", function (e) {
    var itemIs = JSON.parse(btn.dataset.item);
    updateCart(itemIs);
    console.log(itemIs);
  });
});
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["public/css/style"], () => (__webpack_require__("./resources/sass/app.scss")))
